...
Write-Output "auto_fix=apply-auto-remediation.ps1 (GL spike / crash -> audit + app relaunch)"
Write-Output "app_restart=auto on incident (throttle 45m, critical GL>=80MB immediate)"
