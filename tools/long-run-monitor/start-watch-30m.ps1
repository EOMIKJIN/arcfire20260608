...
Write-Output "app_restart=auto on real leak(3x spike·baseline drift) or hard-ceiling(GL>=200MB·PSS>=950MB except combat-range PSS plateau); stable combat footprint held (v2.8)"
