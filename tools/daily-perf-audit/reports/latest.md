# Daily audit — 2026-06-22T15:00:06.498Z
...
- 146,338 — `src/components/planet/PlanetEdenRaidTestLayer.tsx`
...
- 65,211 — `src/i18n/locales/ko.ts`
- 59,311 — `src/i18n/locales/en.ts`
- 52,177 — `app/(game)/planet.tsx`
- 48,714 — `app/(game)/worldmap.tsx`
- 47,561 — `app/(game)/shipyard.tsx`
