# Daily audit — 2026-06-21T15:00:06.933Z
...
- 60,344 — `src/i18n/locales/ko.ts`
- 54,848 — `src/i18n/locales/en.ts`
- 51,707 — `app/(game)/planet.tsx`
- 45,795 — `app/(game)/worldmap.tsx`
- 45,227 — `app/(game)/trade.tsx`
- 45,147 — `app/(game)/shipyard.tsx`
- 41,852 — `src/components/planet/planetHub/planetHubSubcomponents.tsx`
- 35,036 — `src/components/planet/PlanetEdenRaidOrbitSkiaCombat.tsx`
- 31,924 — `src/data/generated/csvMissions.ts`
- 29,666 — `src/types/index.ts`
