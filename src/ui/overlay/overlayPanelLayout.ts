...
/** 행성개발 상세 상단 설명 — 4줄 (방위위성 개척 조건 포함). 목록 3줄과 분리 */
export const PLANET_DEV_DETAIL_DESCRIPTION_LINES = 4;
export const PLANET_DEV_DETAIL_DESCRIPTION_LINE_HEIGHT_PX = PLANET_INFO_DESCRIPTION_LINE_HEIGHT_PX;
export const PLANET_DEV_DETAIL_DESCRIPTION_LINE_SLACK_PX = 2;
export const PLANET_DEV_DETAIL_DESCRIPTION_BLOCK_HEIGHT_PX =
  PLANET_DEV_DETAIL_DESCRIPTION_LINES * (
    PLANET_DEV_DETAIL_DESCRIPTION_LINE_HEIGHT_PX + PLANET_DEV_DETAIL_DESCRIPTION_LINE_SLACK_PX
  );
