    ...
    planets: [
      {
        ...
        coreEnvironment: 46,
        backdropImageAssetKey: null,
        infoPanelPortraitAssetKey: "assets/images/planet/pip_core_solar_station.jpg",
        mainStageSkiaNebulaEnabled: true,
        mainStageBackdropImageEnabled: false,
      }
    ],
    ...
    planets: [
      {
        ...
        coreEnvironment: 38,
        backdropImageAssetKey: null,
        infoPanelPortraitAssetKey: "assets/images/planet/pip_core_minerva_deep.jpg",
        mainStageSkiaNebulaEnabled: true,
        mainStageBackdropImageEnabled: false,
      }
    ],
    ...
    planets: [
      {
        ...
        coreEnvironment: 42,
        backdropImageAssetKey: null,
        infoPanelPortraitAssetKey: "assets/images/planet/pip_core_vega_base.jpg",
        mainStageSkiaNebulaEnabled: true,
        mainStageBackdropImageEnabled: false,
      }
    ],
    ...
    planets: [
      {
        ...
        coreEnvironment: 52,
        backdropImageAssetKey: null,
        infoPanelPortraitAssetKey: "assets/images/planet/pip_core_eden_city.jpg",
        mainStageSkiaNebulaEnabled: true,
        mainStageBackdropImageEnabled: false,
      }
    ],
    ...
    planets: [
      {
        ...
        coreEnvironment: 34,
        backdropImageAssetKey: null,
        infoPanelPortraitAssetKey: "assets/images/planet/pip_core_iron_remnant.jpg",
        mainStageSkiaNebulaEnabled: true,
        mainStageBackdropImageEnabled: false,
      }
    ],
    ...
    planets: [
      {
        ...
        coreEnvironment: 50,
        backdropImageAssetKey: null,
        infoPanelPortraitAssetKey: "assets/images/planet/pip_core_draco_haven.jpg",
        mainStageSkiaNebulaEnabled: true,
        mainStageBackdropImageEnabled: false,
      }
    ],
    ...
    planets: [
      {
        ...
        coreEnvironment: 44,
        backdropImageAssetKey: null,
        infoPanelPortraitAssetKey: "assets/images/planet/pip_core_omega_hub.jpg",
        mainStageSkiaNebulaEnabled: true,
        mainStageBackdropImageEnabled: false,
      }
    ],
    ...
    planets: [
      {
        ...
        coreEnvironment: 48,
        backdropImageAssetKey: null,
        infoPanelPortraitAssetKey: "assets/images/planet/pip_core_helios_core.jpg",
        mainStageSkiaNebulaEnabled: true,
        mainStageBackdropImageEnabled: false,
      }
    ],
    ...
    planets: [
      {
        ...
        coreEnvironment: 42,
        backdropImageAssetKey: null,
        infoPanelPortraitAssetKey: "assets/images/planet/pip_core_sirius_border.jpg",
        mainStageSkiaNebulaEnabled: true,
        mainStageBackdropImageEnabled: false,
      }
    ],
    ...
    planets: [
      {
        ...
        coreEnvironment: 46,
        backdropImageAssetKey: null,
        infoPanelPortraitAssetKey: "assets/images/planet/pip_core_titan_ruins.jpg",
        mainStageSkiaNebulaEnabled: true,
        mainStageBackdropImageEnabled: false,
      }
    ],
    ...
    planets: [
      {
        ...
        coreEnvironment: 44,
        backdropImageAssetKey: null,
        infoPanelPortraitAssetKey: "assets/images/planet/pip_core_perseus_memorial.jpg",
        mainStageSkiaNebulaEnabled: true,
        mainStageBackdropImageEnabled: false,
      }
    ],
    ...
    planets: [
      {
        ...
        coreEnvironment: 34,
        backdropImageAssetKey: null,
        infoPanelPortraitAssetKey: "assets/images/planet/pip_core_crimson_base.jpg",
        mainStageSkiaNebulaEnabled: true,
        mainStageBackdropImageEnabled: false,
      }
    ],
    ...
    planets: [
      {
        ...
        coreEnvironment: 36,
        backdropImageAssetKey: null,
        infoPanelPortraitAssetKey: "assets/images/planet/pip_core_dark_haven.jpg",
        mainStageSkiaNebulaEnabled: true,
        mainStageBackdropImageEnabled: false,
      }
    ],
    ...
    planets: [
      {
        ...
        coreEnvironment: 32,
        backdropImageAssetKey: null,
        infoPanelPortraitAssetKey: "assets/images/planet/pip_core_blood_station.jpg",
        mainStageSkiaNebulaEnabled: true,
        mainStageBackdropImageEnabled: false,
      }
    ],
    ...
    planets: [
      {
        ...
        coreEnvironment: 38,
        backdropImageAssetKey: null,
        infoPanelPortraitAssetKey: "assets/images/planet/pip_core_shadow_market.jpg",
        mainStageSkiaNebulaEnabled: true,
        mainStageBackdropImageEnabled: false,
      }
    ],
    ...
    planets: [
      {
        ...
        coreEnvironment: 32,
        backdropImageAssetKey: null,
        infoPanelPortraitAssetKey: "assets/images/planet/pip_core_abyss_gate.jpg",
        mainStageSkiaNebulaEnabled: true,
        mainStageBackdropImageEnabled: false,
      }
    ],
    ...
    planets: [
      {
        ...
        coreEnvironment: 30,
        backdropImageAssetKey: null,
        infoPanelPortraitAssetKey: "assets/images/planet/pip_core_nightfall_citadel.jpg",
        mainStageSkiaNebulaEnabled: true,
        mainStageBackdropImageEnabled: false,
      }
    ],
    ...
    planets: [
      {
        ...
        coreEnvironment: 48,
        backdropImageAssetKey: null,
        infoPanelPortraitAssetKey: "assets/images/planet/pip_core_core_prime.jpg",
        mainStageSkiaNebulaEnabled: true,
        mainStageBackdropImageEnabled: false,
      }
    ],
    ...
    planets: [
      {
        ...
        coreEnvironment: 46,
        backdropImageAssetKey: null,
        infoPanelPortraitAssetKey: "assets/images/planet/pip_core_eternal_throne.jpg",
        mainStageSkiaNebulaEnabled: true,
        mainStageBackdropImageEnabled: false,
      }
    ],
    ...
    planets: [
      {
        ...
        coreEnvironment: 52,
        backdropImageAssetKey: null,
        infoPanelPortraitAssetKey: "assets/images/planet/pip_core_genesis_origin.jpg",
        mainStageSkiaNebulaEnabled: true,
        mainStageBackdropImageEnabled: false,
      }
    ],
