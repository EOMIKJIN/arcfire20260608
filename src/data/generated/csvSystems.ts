...
export const STAR_SYSTEMS_FROM_CSV: Record<string, StarSystem> = {
    ...
    planets: [
      {
        ...
        descriptionEn: "A peaceful planet of vast grasslands.",
        hasTradePort: true,
        hasShipyard: true,
        hasTavern: true,
        tradeGoods: [],
    ...
    planets: [
      {
        ...
        descriptionEn: "A massive space station in place of a planet.",
        hasTradePort: true,
        hasShipyard: true,
        hasTavern: true,
        tradeGoods: [],
    ...
    planets: [
      {
        ...
        descriptionEn: "Underground mines cover the entire planet.",
        hasTradePort: true,
        hasShipyard: false,
        hasTavern: true,
        tradeGoods: [],
    ...
    planets: [
      {
        ...
        descriptionEn: "A city built around a military base.",
        hasTradePort: false,
        hasShipyard: true,
        hasTavern: true,
        tradeGoods: [],
  ...
  "new_eden": {
    ...
    planets: [
      {
        ...
        descriptionEn: "A lawless place. You can buy anything.",
        hasTradePort: true,
        hasShipyard: true,
        hasTavern: true,
        tradeGoods: [],
    ...
    descriptionEn: "A free trade zone belonging to no faction.",
  },
  "iron_cross": {
    id: "iron_cross",
    name: "아이언 크로스",
    ...
    planets: [
      {
        ...
        descriptionEn: "A settlement of survivors among the wreckage.",
        hasTradePort: true,
        hasShipyard: true,
        hasTavern: true,
        tradeGoods: [],
    ...
    planets: [
      {
        ...
        descriptionEn: "A special research facility powered by nebula energy.",
        hasTradePort: true,
        hasShipyard: false,
        hasTavern: true,
        tradeGoods: [],
    ...
    planets: [
      {
        ...
        descriptionEn: "A large space station operating around the clock.",
        hasTradePort: true,
        hasShipyard: true,
        hasTavern: true,
        tradeGoods: [],
    ...
    planets: [
      {
        ...
        descriptionEn: "The last safe settlement on the frontier.",
        hasTradePort: true,
        hasShipyard: true,
        hasTavern: true,
        tradeGoods: [],
    ...
    planets: [
      {
        ...
        descriptionEn: "A memorial planet honoring past heroes.",
        hasTradePort: true,
        hasShipyard: true,
        hasTavern: true,
        tradeGoods: [],
    ...
    planets: [
      {
        ...
        descriptionEn: "Pirate and mercenary stronghold. High risk, high reward.",
        hasTradePort: true,
        hasShipyard: true,
        hasTavern: true,
        tradeGoods: [],
    ...
    planets: [
      {
        ...
        descriptionEn: "A secret base inside warped space.",
        hasTradePort: true,
        hasShipyard: false,
        hasTavern: true,
        tradeGoods: [],
    ...
    planets: [
      {
        ...
        descriptionEn: "A floating station filled with scars of battle.",
        hasTradePort: true,
        hasShipyard: true,
        hasTavern: true,
        tradeGoods: [],
    ...
    planets: [
      {
        ...
        descriptionEn: "The last gate toward the final zone.",
        hasTradePort: false,
        hasShipyard: true,
        hasTavern: true,
        tradeGoods: [],
    ...
    planets: [
      {
        ...
        descriptionEn: "A fortress ruled by lords of darkness.",
        hasTradePort: true,
        hasShipyard: true,
        hasTavern: false,
        tradeGoods: [],
  ...
  "arcfire_core": {
    ...
    planets: [
      {
        ...
        descriptionEn: "A sacred planet where galactic energy gathers.",
        hasTradePort: true,
        hasShipyard: true,
        hasTavern: true,
        tradeGoods: [],
    ...
    descriptionEn: "★ Endgame. Heart of the Arcfire galaxy. Only legendary pilots reach it.",
  },
  "eternity": {
    id: "eternity",
    name: "이터니티",
