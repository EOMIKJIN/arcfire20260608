...
export const SHIP_TEMPLATES_FROM_CSV: Record<string, ShipTemplate> = {
  ...
  "Player_frigate_mk2": {
    ...
    name: "��Ʈ����Ŀ Mk.II",
    description: "��Ʈ����Ŀ Mk.II 플레이어 템플릿",
    maxHp: 400,
    maxShield: 95,
    armor: 9,
    speed: 8,
