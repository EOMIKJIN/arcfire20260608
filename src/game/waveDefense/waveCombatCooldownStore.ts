// ============================================================
// 웨이브 전투 재개 대기(쿨다운) — 단일 정본.
//
// 규칙(대표님 지시 2026-07-22): 적 행성 웨이브 전투에서 **승리**하면
// 해당 행성은 30분간 새 웨이브 전투가 트리거되지 않는다.
// - 승리 결과창 표시 중 즉시 재기동(중복 처리) 회귀의 구조적 차단 축.
// - 이 30분은 전체 전술의 일부 규칙 — 향후 「전투 재개 전술화」 고도화 시
//   이 모듈의 시간·조건만 확장한다(트리거 정본 resolvePlanetWaveCombatTrigger 소비).
//
...
/** 웨이브 전투 승리 시 1회 기록 — 이후 30분간 해당 행성 웨이브 트리거 차단 */
